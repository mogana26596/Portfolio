...
<div>
  ...
  <div className="row g-8">
    ...
    <div className="col-md-6">
        ...
        <a href="https://github.com/mogana26596/homestayreact" className="btn btn-light d-md-flex justify-content-md-center" target="_blank">HomeStaybnb clone - Frontend</a>
        <a href="https://github.com/mogana26596/homestaynode" className="btn btn-light d-md-flex justify-content-md-center" target="_blank">HomeStaybnb clone - Backend</a>
        <a href="https://homestaybnb.netlify.app/"className="btn btn-light d-md-flex justify-content-md-center" target="_blank">HomeStaybnb clone - Deployed URL</a> 
    </div>
  </div>
</div>
...
<div className="container">
  <div className="row g-8">
    ...
    <a href="https://github.com/mogana26596/libraryreact" className="btn btn-light d-md-flex justify-content-md-center" target="_blank">Library Management clone - Frontend</a>
        <a href="https://github.com/mogana26596/librarynodejs" className="btn btn-light d-md-flex justify-content-md-center" target="_blank">Library Management clone - Backend</a> 
        <a href="https://librarymanagementclone.netlify.app/" className="btn btn-light d-md-flex justify-content-md-center" target="_blank">Library Management clone - Deployed URL</a> 
    </div>
  </div>
</div>
...
<div className="container">
  <div className="row g-8">
    ...
    <a href="https://github.com/mogana26596/weather-app" className="btn btn-light d-md-flex justify-content-md-center" target="_blank">Weather Application</a>
        <a href="https://weatherforecastreactapp.netlify.app/" className="btn btn-light d-md-flex justify-content-md-center" target="_blank">Weather Application - Deployed URL</a> 
    </div>
  </div>
</div>
  ...
  <div className="row g-8">
    ...
    <div className="col-md-6">
        ...
        <a href="https://github.com/mogana26596/onlineshopfrontend" className="btn btn-light d-md-flex justify-content-md-center" target="_blank">Online fruits and Vegetables market shop - Frontend</a>
        <a href="https://github.com/mogana26596/onlineshoppingbackend" className="btn btn-light d-md-flex justify-content-md-center" target="_blank">Online fruits and Vegetables market shop - Backend</a> 
        <a href="https://onlineshoppinmarket.netlify.app/" className="btn btn-light d-md-flex justify-content-md-center" target="_blank">Online fruits and Vegetables market shop - Deployed URL</a> 
    </div>
  </div>
</div>
...
<div className="container">
  <div className="row g-8">
    ...
    <a href="https://github.com/mogana26596/userreact" className="btn btn-light d-md-flex justify-content-md-center" target="_blank">School Management clone - Frontend</a>
        <a href="https://github.com/mogana26596/usernodejs" className="btn btn-light d-md-flex justify-content-md-center" target="_blank">School Management clone - Backend</a> 
        <a href="https://schoolmanagement11.netlify.app/" className="btn btn-light d-md-flex justify-content-md-center" target="_blank">School Management clone - Deployed URL</a> 
    </div>
  </div>
</div>
